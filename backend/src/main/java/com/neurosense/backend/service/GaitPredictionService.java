...
@Service
public class GaitPredictionService {

    private static final String SCRIPT_PATH = "ml-model/inference/gait_analysis.py";
    ...
    public Map<String, Object> predict(String jsonData) {
        try {
            ...
            File tempFile = File.createTempFile("gait_" + UUID.randomUUID(), ".json");
            ...
            Thread stderrDrainer = new Thread(() -> {
                try (BufferedReader errReader = new BufferedReader(
                    ...
                    while ((errLine = errReader.readLine()) != null) {
                        System.err.println("GAIT MODEL STDERR: " + errLine);
                    }
            ...
            while ((line = reader.readLine()) != null) {
                System.out.println("GAIT MODEL OUTPUT: " + line);
            ...
            if (jsonLine == null) {
                throw new RuntimeException("No JSON output found from gait model");
            }
            ...
            e.printStackTrace();
            throw new RuntimeException("Gait prediction failed: " + e.getMessage(), e);
        }
    }
}
